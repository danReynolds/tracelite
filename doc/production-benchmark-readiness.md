...
Windows traced-hook build fix merge
`4e9f0fbd658fc320a9847547af318cb9428e1f15`, which includes the downstream r12
policy merge plus Windows path and platform C-standard hook fixes. Linux
