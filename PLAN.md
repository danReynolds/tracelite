...
- The public `tracelite` library is now core-only. The published `bin/`
  ...
  `tool/src/` behind the source-checkout handoff, and their dependencies are
...
to `lib/src/core_cli.dart`: `report`, `decision`, `calibrate-policy`,
